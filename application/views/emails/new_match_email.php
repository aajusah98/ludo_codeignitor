    ...
    <td align="left" valign="top">
      <div>
        <div style="background-color: #fff;height: 100px; text-align: center;" >
          <img src="<?php echo base_url(); ?>assets/images/logo.png" width="280" style="border:1px solid white; background-color: white;padding: 10px 10px 10px 10px">
        </div>
      </div>
    </td>
  </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
        <tr>
          <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#000000;">
            <div style="font-family: Montserrat, 'Times New Roman', Times, serif; font-size:56px; color:#000000;">Confirmation
            </div>
            <br>
            <div style="font-size: 18px;">
              <p>Hey Do you know someone set new match, details of match are</p>

          <div style="font-size: 23px;"><br>
              Hi <?php echo $name;?>,<br>
            </div>
              <h4>Seter Name : <span><?php echo getUserName($user_id);?></span></h4>
               <h4>BetAmount : <span><?php echo $betAmount;?></span></h4>
            </div>
            <br>
