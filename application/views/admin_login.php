      ...
      <div class="row">
        <div class="col-xl-12 col-md-12 col-md-12">
          <div class="card">
            ...
            <?php }?>
              <form method="post" action="<?php echo base_url(); ?>welcome/admin_login_chk" >
              ...
              <div class="row">
                <div class="col-12"> <button type="submit" class="btn btn-primary btn-block logn-btn" name="admin_login" >Login</button> </div>
              </div>
            </form>
